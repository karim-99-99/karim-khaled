  ...
  const features = [
    {
      ...
      description: 'منهج واضح، شامل، ومختصر يربط الأفكار ويثبت الفهم.',
    },
    {
      icon: '🎓',
      title: 'خبرة أكثر من 10 سنوات في التدريب',
      description: 'سنوات عمل في تدريب القدرات للقسمين اللفظي والكمي.',
    },
    {
      icon: '📱',
