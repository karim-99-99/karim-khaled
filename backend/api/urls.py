...
urlpatterns = [
    ...
    path('public/try-free/', views.PublicTryFreeView.as_view(), name='public-try-free'),
    path('public/try-free/bunny-signed-url/', views.PublicTryFreeBunnySignedUrlView.as_view(), name='public-try-free-bunny'),
    path('public/try-free/<str:lesson_id>/', views.PublicTryFreeLessonView.as_view(), name='public-try-free-lesson'),
    ...
    path('tiger-test/banks/', tiger_test_views.TigerTestBanksView.as_view(), name='tiger-test-banks'),
    ...
    path('tiger-test/history/', tiger_test_views.TigerTestHistoryView.as_view(), name='tiger-test-history'),
